...
<header class="bg-gradient">
    <div class="container mt-5">
        <h1 class="arbaic-text-title" style="padding-bottom: 20px"> <strong>امتحان القبطي</strong> </h1>
    </div>
</header>
...
if(isset($_POST['submit']))
{
    ...
    for($i=0;$i<$numberOfQuestions;$i++)
    {
        ...
        $sql = $sql . ';' . "INSERT INTO `studentcopticexamanswers`(`ClassID`, `Code`, `CorrectChoice`, `QuestionNumber`, `StudentChoice`) VALUES (?,?,?,?,?)";
    ...
    $sql = "UPDATE studentcopticexamresults SET CopticExamScore = ".$score.", Submission_Time = '".date('Y/m/d H:i:s', time())."' WHERE Code= ".$_COOKIE['player-code']." AND ClassID = ".$classNumber.";";
...
<div class=" d-flex center flex-column" style="padding: 80px; align-items: center">
    <h2 class="arbaic-text-small-nav" style="text-align:center;font-size: xx-large; color: #004085; text-align: center">تم تسليم إجابات امتحان القبطي بنجاح! شكراً لك!</h2>
