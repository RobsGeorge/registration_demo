...
if(isset($_POST['submit']))
{
    ...
    for($i=0;$i<$numberOfQuestions;$i++)
    {
        ...
        $sql = $sql . ';' . "INSERT INTO `studenttaksexamanswers`(`ClassID`, `Code`, `CorrectChoice`, `QuestionNumber`, `StudentChoice`) VALUES (?,?,?,?,?)";
    ...
    $sql = "UPDATE studenttaksexamresults SET TaksExamScore = ".$score.", Submission_Time = '".date('Y/m/d H:i:s', time())."' WHERE Code= ".$_COOKIE['player-code']." AND ClassID = ".$classNumber.";";
...
<div class=" d-flex center flex-column" style="padding: 80px; align-items: center">
    <h2 class="arbaic-text-small-nav" style="text-align:center;font-size: xx-large; color: #810085; text-align: center">تم تسليم إجابات امتحان الطقس بنجاح! شكراً لك!</h2>
    ...
    <a href="takspage.php" class="btn btn-primary" style="padding: 15px;margin: 10px">العودة للطقس</a>
