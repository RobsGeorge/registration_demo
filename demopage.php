...
<header class="bg-gradient" id="home">
    <div class="container mt-5">
        <h1 class="arbaic-text-title"> <strong>امتحان تجريبي</strong> </h1>
        <p class="tagline" style="padding-bottom: 20px;">نتناول في هذا الامتحان تجربة فقط للامتحان وهو ليس له أي تقييم مطلقاً</p>
    </div>
</header>
        ...
        <div class="container">
            <div class="row" dir="ltr">
                <div class="col-sm-2 col-lg">
                    <img src="images/a.jpg" alt="dual phone" class="hymn-image">
                </div>
                <div class="cold-md-6 d-flex align-items-right">
                    <div>
                        ...
                        <a href="solvedemowarning.php" target="_blank" class="btn btn-primary arbaic-text-small-nav">الذهاب للامتحان التجريبي</a>
                    </div>
                </div>
            </div>
        </div>
