...
<header class="bg-gradient" id="home">
    <div class="container mt-5">
        <h1 class="arbaic-text-title"> <strong>امتحان الأجبية</strong> </h1>
        <p class="tagline" style="padding-bottom: 20px;">نتناول هذا العام بعض صلوات الأجبية في كنيستنا القبطية.</p>
    </div>
</header>
            ...
            <div class="row" dir="ltr">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div>
                        ...
                        <a href="solveagbiawarning.php" target="_blank" class="btn btn-primary arbaic-text-small-nav">الذهاب لامتحان الأجبية</a>
                    </div>
                </div>
            </div>
        </div>
