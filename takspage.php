...
<header class="bg-gradient" id="home">
    <div class="container mt-5">
        <h1 class="arbaic-text-title"> <strong>امتحان الطقس</strong> </h1>
        <p class="tagline" style="padding-bottom: 20px;">نتناول هذا العام بعض من طقوس كنيستنا القبطية الجميلة.</p>
    </div>
</header>
        ...
        <div class="container">
            <div class="row" dir="ltr">
                <div class="col-sm-2 col-lg">
                    <img src="images/church.jpg" alt="dual phone" class="hymn-image">
                </div>
                <div class="col-md-6 d-flex align-items-center">
                    <div>
                        ...
                        <a href="solvetakswarning.php" target="_blank" class="btn btn-primary arbaic-text-small-nav">الذهاب لامتحان الطقس</a>
                    </div>
                </div>
            </div>
        </div>
