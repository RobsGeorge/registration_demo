...
if(isset($_POST['submit']))
{
    ...
    for($i=0;$i<$numberOfQuestions;$i++)
    {
        ...
        $sql = $sql . ';' . "INSERT INTO `studentagbiaexamanswers`(`ClassID`, `Code`, `CorrectChoice`, `QuestionNumber`, `StudentChoice`) VALUES (?,?,?,?,?)";
    ...
    $sql = "UPDATE studentagbiaexamresults SET AgbiaExamScore = ".$score.", Submission_Time = '".date('Y/m/d H:i:s', time())."' WHERE Code= ".$_COOKIE['player-code']." AND ClassID = ".$classNumber.";";
...
<div class=" d-flex center flex-column" style="padding: 80px; align-items: center">
    <h2 class="arbaic-text-small-nav" style="text-align:center;font-size: xx-large; color: #004085; text-align: center">تم تسليم إجابات امتحان الأجبية بنجاح! شكراً لك!</h2>
    <a href="copticpage.php" class="btn btn-primary" style="padding: 15px;margin: 10px">العودة للأجبية</a>
