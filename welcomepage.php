        ...
        <div class="row">
            <div class="col-12">
                <div class="general-card">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="subtitle-heading2"> تم تأكيد البيانات بنجاح. برجاء التوجه إلى كنترول مدرسة الشمامسة لاستلام الكود الخاص بك في مدرسة الشمامسة. ورجاء احضار صورة شهادة الميلاد أو صورة بطاقة الرقم القومي زائد صورة شخصية مقاس 4 في 6.</h3>
                        </div>
                        <div class="card-body">
                        <h4 class="right" style="color: #000000; text-align:right;"> 
                                ملحوظة: لن يتم دخول الامتحانات لأي شخص لم يقم بتسليم صورة الرقم القومي والصورة الشخصية في الكنترول واستلام الكود الخاص بكم. وبرجاء ترك مبلغ 100 جنيه للاشترك هذا العام (اذا لم يكن قد تم دفعه من قبل)
                        </h4>
                        <br>
                        <h4 class="right" style="color: #F00000; text-align:center;"> 
                                مواعيد كنترول مدرسة الشمامسة: الجمعة من 9:30 صباحاً حتى الساعة 1 ظهراً... ويوم الأحد من 6:30 مساءً حتى الساعة 8 مساءً
                        </h4>
</div>
                    </div>
                </div>
