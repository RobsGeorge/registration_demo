...
<head>
    <title>RecordRTC Audio+Video Recording & Uploading to PHP Server</title><link rel="shortcut icon" type="image/x-icon" href="images/BG.png" />
