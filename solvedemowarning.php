...
<header class="bg-gradient">
    <div class="container mt-5">
        <h1 class="arbaic-text-title" style="padding-bottom: 20px"> <strong>امتحان تجريبي</strong> </h1>
    </div>
</header>
...
<div class=" d-flex center flex-column" style="padding: 80px; align-items: center">
    ...
    <a href="solvedemo.php" class="btn btn-primary" style="font-size:25px; padding: 15px;margin: 10px">الذهاب للامتحان التجريبي</a>
