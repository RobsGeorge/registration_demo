    ...
    <div class="container">
        <div class="call-to-action">
            ...
            <div class="my-4">
                ...
                <a href="#" class="btn btn-light arbaic-text-small-nav">القبطي</a>
                <a href="#" class="btn btn-light arbaic-text-small-nav">الطقس</a>
                <a href="#" class="btn btn-light arbaic-text-small-nav">الأجبية</a>
