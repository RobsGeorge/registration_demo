...
<header class="bg-gradient">
    <div class="container mt-5">
        <h4 style="font-size:25px; color: #4E1370;"  >حساب الخادم الشخصي</h4>
        <br>
...
<div class="container">
    <div class="row">
    <div class="col-md-3">
            <h2  class="arbaic-text-heading" style="text-align: center; color: #f5378e" dir="ltr">امتحان الألحان</h2>
            <a href="tasheehalhan.php" class="btn btn-primary3" style="text-decoration:underline;color: #8D26B6; text-align: center;" dir="ltr">الذهاب لتصحيح ألحان فصلك</a>
        </div>
        <!--
        <div class="col-md-3">
...
<div class="section">
    <div class="container d-flex center align-items-center">
        <div class="d-flex center align-items-center" style="align-self: center">
                <a href="tasheehalhan.php" class="btn btn-outline-dark my-3 my-sm-0 ml-lg-3 arbaic-text-small-nav" style="align-self:center;border-color: #f5378e">الذهاب لتصحيح ألحان فصلك</a>
        </div>
    </div>
</div>
-->
