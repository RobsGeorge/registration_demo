...
<div class=" d-flex center flex-column" style="padding: 80px; align-items: center">
    ...
    <p class="arbaic-text-small-nav" style="color: black; text-align: center">امتحان القبطي هو عبارة عن امتحان له مدة زمنية محددة، مع انتهاء المدة يتم غلق الصفحة تلقائياً وتسليم الاجابات التي تمت الاجابة عليها فقط.</p>
    ...
    <a href="solveCoptic.php" class="btn btn-primary" style="font-size:25px; padding: 15px;margin: 10px">الذهاب لامتحان القبطي</a>
